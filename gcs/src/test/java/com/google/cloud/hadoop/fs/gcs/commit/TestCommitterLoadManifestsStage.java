...
/**
 * Test loading manifests from a store. By not creating files we can simulate a large job just by
 * creating the manifests. The SaveTaskManifestStage stage is used for the save operation; this does
 * a save + rename. For better test performance against a remote store, a thread pool is used to
 * save the manifests in parallel.
 */
public class TestCommitterLoadManifestsStage extends TestLoadManifestsStage {
